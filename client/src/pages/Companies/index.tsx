...
import DetailsCompanyModal from "../../components/Modal/Company/Details";
import InsertCompanyModal from "../../components/Modal/Company/Insert";
...
const Companies: React.FC = (): JSX.Element => {
    ...
    const fetchData = async (): Promise<void> => {
        try {
            let url: string = `http://localhost:44405/api/v1/companies?page=${page}&size=${size}`;
            if (search !== "") {
                url = url.concat(`&nomeFantasia=${search}&razaoSocial=${search}`);
            }
